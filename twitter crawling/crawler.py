...
def get_tweets(api, tag, date):
    ...
    results = api.GetSearch(term=tag, count=100, until=next_d)
    # print(results)
...
def crawl(date, tags):
    # api = twitter.Api(consumer_key='wklaEQfhDVGXfy8rpfw1ko8tX',
    #                   consumer_secret='w2eDqOgQGSWfWJASHM7SBYXTWspDi9NiIvkTlUrz4FW8i1aGMV',
    #                   access_token_key='1013820252-0uNb7vD9oY5YObc3KsyrhNdoRmyzRKQytXpZk0i',
    #                   access_token_secret='NnsjS4vXMccCuyEPgTdURj63MeVXLtCtJLncNjX3cy0LQ')
    api = twitter.Api(consumer_key='Siu24RCiqcTSQtYsPXVbwUdb6',
                      consumer_secret='hVoO5aOn9j3iC3DKZeuDD6pRAwdvrDarMiBZFVSOO5TIV960cS',
                      access_token_key='711193691105275904-mAqNjd1WTbskslrKLDYrOp9X1QPXMhr',
                      access_token_secret='bzqBwPVFVUley0GxfGHFCSpRnjaeAxsNDALamYa7j7bZz')
    stats, tweets = [], []
    for tag in tags:
